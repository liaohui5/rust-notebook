...
| [is_none_or](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.is_none_or)   | 如果option为none返回true, 否则返回闭包函数返回的值 |
...
::: danger 注意点
`unwrap` 和 `expect` 遇到 `None` 会直接 `panic`, 一般只建议在测试代码中使用,
或者你明确代码执行逻辑就应该 `panic`, 那么可以使用 `expect`,
或　或者确定值一定存在的情况下使用 `unwrap`, 正常业务代码推荐使用 `unwrap_or` 系列方法
:::
...
| 方法                                                                                     | 作用                                                                 |
| :--------------------------------------------------------------------------------------- | :------------------------------------------------------------------- |
| [map](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.map)                 | 将 Some 中的值通过闭包转换(还是返回一个 Option 值), None 不做处理    |
| [map_or](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.map_or)           | 相当于 map(...).unwrap_or(默认值), 直接返回 Some 中的值              |
...
| [zip](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.zip)         | 将两个 `Option` 压缩为 一个 `Option<(T, U)>` 值为元组               |
| [unzip](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.unzip)     | 将一个 `Option<(T, U)>` 值为元组解压缩为 `Option<T>` 和 `Option<U>` |
...
| [insert](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.insert)                         |                                                   |
| [get_or_insert](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.get_or_insert)           | 没有值时先插入默认值, 再返回值的引用              |
| [get_or_insert_with](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.get_or_insert_with) | 与 get_or_insert 效果一样, 但参数是闭包(惰性求值) |
...
| [transpose](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.transpose)   | 将 `Option<Result<T, E>>` 转为 `Result<Option<T>, E>` |
...
| 方法                                                                                       | 作用                              |
| :----------------------------------------------------------------------------------------- | :-------------------------------- |
| [as_ref](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.as_ref)             | 将 `&Option<T>` 转为 `Option<&T>` |
| [as_deref](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.as_deref)         |                                   |
| [as_mut](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.as_mut)             |                                   |
| [as_deref_mut](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.as_deref_mut) |                                   |
| [iter](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.iter)                 |                                   |
| [iter_mut](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.iter_mut)         |                                   |
| [cloned](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.cloned)             |                                   |
| [copied](https://rustwiki.org/zh-CN/std/option/enum.Option.html#method.copied)             |                                   |
